...
import { ServicesPageHeroContent } from '@/content/schemas/services-page.schema';
import styles from './ServicesHeroSection.module.css';

export interface ServicesHeroSectionProps {
  content: ServicesPageHeroContent;
}

/**
 * ServicesHeroSection — Figma node 30:18 (Page / Services / Section / Page Hero)
 *
 * 1440 reference (section height 568):
 *   nav      y=37  (1250x83, supplied globally by Navbar)
 *   headline y=193 797x160  — 72px/80px Bold, tracking -2.16  (30:24)
 *   sub      y=377 760x64   — 20px/32px Regular, secondary     (30:25)
 *   icon     x=893 y=98.5   443x443                            (114:3)
 ...
 */
export const ServicesHeroSection: React.FC<ServicesHeroSectionProps> = ({ content }) => {
  return (
    <SectionWrapper theme="canvas" padding="custom" id="services-hero" className={styles.heroSection}>
